...
adj <- 1.78 # expantion for unmonitored substocks

harvest_goal <- seq(1000,100000*adj,length.out=40)
egfloor <- seq(1,100000*adj,length.out=40)
...
#outcomes <- readRDS("outputs/base_sims.ny_50.SR_rick.sim_500.TV_false.May312019")
#outcomes <- readRDS("outputs/alt_vul_sims.ny_50.SR_rick.sim_500.TV_false.July32019")
outcomes <- readRDS("outputs/base_sims.ny_50.SR_rick.sim_500.TV_true.May312019")
...
par(mfrow=c(2,2),bty="o", mar=c(2,2,2,5),oma=c(2,2,1,1))#set dimensions to plots

#panel a - harvest
xx<-as.table((outcomes.med[,2,]/1000)*adj)
...
par(mfrow=c(2,2),bty="o", mar=c(1,2,2,4),oma=c(2,2.5,1,0))#set dimensions to plots

har <- c(((outcomes.med[,2,]/1000)*adj)[pol.1x.ind,pol.1y.ind],(outcomes.med[,2,]/1000*adj)[pol.2x.ind,pol.2y.ind],(outcomes.med[,2,]/1000*adj)[pol.3x.ind,pol.3y.ind])
har.up <- c((outcomes.upper[,2,]/1000*adj)[pol.1x.ind,pol.1y.ind],(outcomes.upper[,2,]/1000*adj)[pol.2x.ind,pol.2y.ind],(outcomes.upper[,2,]/1000*adj)[pol.3x.ind,pol.3y.ind])
har.low <- c((outcomes.lower[,2,]/1000*adj)[pol.1x.ind,pol.1y.ind],(outcomes.lower[,2,]/1000*adj)[pol.2x.ind,pol.2y.ind],(outcomes.lower[,2,]/1000*adj)[pol.3x.ind,pol.3y.ind])
...
outcomes <- readRDS("outputs/base_sims.ny_50.SR_rick.sim_500.BH.May312019")
#outcomes <- readRDS("outputs/base_sims.ny_50.SR_rick.sim_200.BH_CV0.2.May292019")
...
### Harvest
har <- c((rk.outcomes.med[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
    	(rk.outcomes.med[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj,
			(tv.outcomes.med[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
			(tv.outcomes.med[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj,
			(bh.outcomes.med[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
			(bh.outcomes.med[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj
			)
			dim(har) <- c(2,3)

har.up <- c((rk.outcomes.upper[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
			(rk.outcomes.upper[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj,
			(tv.outcomes.upper[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
			(tv.outcomes.upper[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj,
			(bh.outcomes.upper[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
			(bh.outcomes.upper[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj
			)
			dim(har.up) <- c(2,3)
			
har.low <- c((rk.outcomes.lower[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
			(rk.outcomes.lower[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj,
			(tv.outcomes.lower[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
			(tv.outcomes.lower[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj,
			(bh.outcomes.lower[,2,]/1000 ) [pol.1x.ind,pol.1y.ind]*adj,
			(bh.outcomes.lower[,2,]/1000 ) [pol.3x.ind,pol.3y.ind]*adj
			)
			dim(har.low) <- c(2,3)
###
...
mtext("Harvest stability (1/CV)",2,line=3)
legend(1.4,1.05,legend=c("Stationary Ricker", "Time varying Ricker", "Time varying Beverton-Holt"),bty="n",fill=c("light grey",blue_bar, green_bar),cex=0.95)
...
base_timeseries <- readRDS("outputs/base_sims.ny_50.SR_rick.sim_500.TV_false.time_series.May312019")
